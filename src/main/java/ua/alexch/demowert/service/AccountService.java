...
import ua.alexch.demowert.repository.IAccountRepository;
import ua.alexch.demowert.util.SecurityUtils;
...
//    @PostAuthorize("returnObject.owner eq principal")
...
//    @PreAuthorize("#account.owner eq principal or hasAuthority('ADMIN')")
    @Transactional
