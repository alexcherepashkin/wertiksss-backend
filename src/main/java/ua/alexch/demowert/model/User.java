...
import ua.alexch.demowert.util.UniqueUsername;
 ...
 */
@Entity
@Table(name = "usrs", uniqueConstraints = { @UniqueConstraint(columnNames = "username") })
public class User implements UserDetails {
    ...
    @CollectionTable(name = "usrs_roles", joinColumns = @JoinColumn(name = "user_id"))
