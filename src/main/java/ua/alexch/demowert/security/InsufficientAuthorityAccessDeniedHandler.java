 ...
 */
@Component
public class InsufficientAuthorityAccessDeniedHandler implements AccessDeniedHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(InsufficientAuthorityAccessDeniedHandler.class);
