...
import ua.alexch.wertiksss.dto.ErrorResponse;
...
import ua.alexch.wertiksss.exception.UserEntityNotFoundException;
...
public class BasicExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
        ...
        log(ex);
        final ErrorResponse body = new ErrorResponse(status, ex.getMessage());
